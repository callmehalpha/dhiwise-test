import '../live_feed_scheduling_screen/widgets/listprofileimglarg1_item_widget.dart';
...
class LiveFeedSchedulingScreen extends GetWidget<LiveFeedSchedulingController> {
  @override
                          ...
                          child: Padding(
                              ...
                              child: Obx(() => ListView.builder(
                                  ...
                                  itemCount: controller
                                      ...
                                      .value
                                      .listprofileimglarg1ItemList
                                      .length,
                                  itemBuilder: (context, index) {
                                    Listprofileimglarg1ItemModel model =
                                        controller
                                            .liveFeedSchedulingModelObj
                                            .value
                                            .listprofileimglarg1ItemList[index];
                                    return Listprofileimglarg1ItemWidget(model);
                                  }))))
                    ]))))));
  }
